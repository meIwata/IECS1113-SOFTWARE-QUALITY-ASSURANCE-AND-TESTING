...
public class People {
    ...
    public void setBirthdayYear(int birthdayYear) {
        ...
        assert birthdayYear >= 1990 && birthdayYear <= currentYear : "生日應該介於1990 ~ " + currentYear;
    ...
    public void setFather(People father) {
        ...
        assert father.birthdayYear < this.birthdayYear : "父親的生日年應該小於自己的生日年";
    }
